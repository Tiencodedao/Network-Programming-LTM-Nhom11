...
│   └── chat_widget.py   # Component chat box
│
└── utils/               # Các tiện ích
    ├── __init__.py
...
- `ChatWidget`: Component chat box real-time
...
7. ✅ **Chat box real-time trong game**
...
```
Ví dụ đã được implement - Chat feature:
✅ network/ - Xử lý gửi/nhận tin nhắn qua TCP
✅ ui/chat_widget.py - UI chat box với ScrolledText
✅ ui/sidebar.py - Tích hợp chat vào sidebar
✅ ui/main_window.py - Callbacks xử lý chat messages
```
